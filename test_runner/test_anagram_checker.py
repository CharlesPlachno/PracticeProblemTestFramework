'''
a set of positive and negative tests for the is_anagram function
'''

from problems.anagram_checker import is_anagram
import pytest

@pytest.mark.parametrize("word1, word2", [["add", "dad"]])
...
@pytest.mark.parametrize("word1, word2", [["dog", "cat"]])
