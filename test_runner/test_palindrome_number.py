...
def test_positives(palindrome):
    """takes paramatrized list of ints and asserts that they are palindromes as expected"""
...
def test_negatives(not_palindrome):
    """takes paramatrized list of ints and asserts that they are not palindromes as expected"""
